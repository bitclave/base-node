...
class BotController {
    ...
    fun getPublicKey(
        @ApiParam("name of the bot", required = true)
        @PathVariable("name") name: String
    ): CompletableFuture<String> {
        return CompletableFuture.completedFuture(
            when {
                "Adam".equals(name, true) -> "038d4a758b58137ee47993ca434c1b797096536ada167b942f7d251ed1fc50c1c1"
                "Base".equals(name, true) -> "BA5E"
                else -> ""
            }
        )
    }
